...
from rt_sign.sign import perform_signing, TMemoryPointer
...
async def sign(sign_request: SignRequest):
    ...
    result:TMemoryPointer = perform_signing(data, sign_request.user_pin.encode(), sign_request.key_pair_id.encode())
